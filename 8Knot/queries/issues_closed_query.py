...
def issues_closed_query(self, repos):
    """
    (Worker Query)
    ...
    query_string = f"""
                    select i.issue_id as issues_closed, r.repo_id as id, i.closed_at as date
